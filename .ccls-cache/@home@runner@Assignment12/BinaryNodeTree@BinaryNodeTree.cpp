...
int BinaryNodeTree<ItemType>::getHeightHelper(BinaryNode<ItemType>* subTreePtr) const //no change
{
...
template<class ItemType>
int BinaryNodeTree<ItemType>::getNumberOfNodesHelper(BinaryNode<ItemType>* subTreePtr) const //no
{
   if (subTreePtr == nullptr)
      return 0;
   else
                                                            ...
                                                            BinaryNode<ItemType>* newNodePtr)
{
   ...
   else
   {
      ...
      if (getHeightHelper(leftPtr) > getHeightHelper(rightPtr)) //here
      {
...
BinaryNode<ItemType>* BinaryNodeTree<ItemType>::moveValuesUpTree(BinaryNode<ItemType>* subTreePtr)
{
   ...
   int rightHeight = getHeightHelper(rightPtr); //no
...
BinaryNode<ItemType>* BinaryNodeTree<ItemType>::findNode(BinaryNode<ItemType>* treePtr, 
                                                         const ItemType& target,
                                                         bool& success) const //might have to make two for name and brith
{
...
template<class ItemType>
BinaryNodeTree<ItemType>::BinaryNodeTree(const ItemType& rootItem) //yes
{
...
template<class ItemType>
ItemType BinaryNodeTree<ItemType>::getNameD(const ItemType& anEntry) const 
{
   bool isSuccessful = false;
   BinaryNode<ItemType>* binaryNodePtr = findNode(rootPtr, anEntry, isSuccessful);

   if (isSuccessful)
      return (binaryNodePtr->getItem()).getName(); 
   else 
      throw NotFoundException("Entry not found in tree!");
}  // end getEntry

template<class ItemType>
ItemType BinaryNodeTree<ItemType>::getBirthD(const ItemType& anEntry) const 
{
   bool isSuccessful = false;
   BinaryNode<ItemType>* binaryNodePtr = findNode(rootPtr, anEntry, isSuccessful);

   if (isSuccessful)
      return (binaryNodePtr->getItem()).getBirth(); 
   else 
      throw NotFoundException("Entry not found in tree!");
}  // end getEntry
